class MiniJuego {
  constructor() {
    ...
    this.cueva = loadImage('assets/cueva.jpg'); // Cargar la imagen de la cueva
  ...
  mostrarPantallaResultado() {
    if (this.juegoTerminado) {
      ...
      if (this.mensaje.includes("Se acabó el tiempo.") || this.mensaje.includes("Los fragmentos de la montaña te dañaron.")) {

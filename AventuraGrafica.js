class AventuraGrafica {
  ...
  setup() {
    ...
    this.botones.push(new BotonRedondeado(300, 450, "Usar el Geiser"));//17
    ...
    const pantalla13 = new Pantalla(this.imagenes[12], [
      this.botones[16],
      this.botones[17],
      ], ["Ya casi agonizando del calor por la subida de temperatura", "tienes que tomar la ÚLTIMA decisión para poder escapar", "A tu disposición solo te queda DINAMITA, pero", "te das cuenta de un GEISER que podría ser", "clave para subir a la superficie"]);
    ...
    // Pantalla Final 2
    const final2 = new Pantalla(this.imagenes[14], [this.botones[18]], ["¡INCREÍBLE! consiguen empujar una calavera de", "dinosaurio sobre el Heizer y se suben sobre él.", "El Geiser erupciona y", "salen volando por los aires", "¡SIIIII!"]);
